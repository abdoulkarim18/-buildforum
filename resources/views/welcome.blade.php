                ...
                <table class="table table-striped table-responsive table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <h3 class="h5">
                                    <a href="{{route('forum.overview', $forum)}}"
                            ...
                            <td>
                                <div>{{$forum->discussions->count()}}</div>
                            </td>
                            {{-- <td>
                                <div>{{$forum->posts}}</div>
                            </td> --}}
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li><a href="{{route('client.user.profile', $user)}}">{{$user->name}} <span
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li><a href="{{route('client.user.profile', $user)}}">{{$user->name}}</a></li>
                        @endforeach
                        @endif
