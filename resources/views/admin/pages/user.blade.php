                                        ...
                                        <form class="form-horizontal" method="POST"
                                            ...
                                            <div class="form-group row">
                                                <label for="inputSkills"
                                                    class="col-sm-2 col-form-label">Proffession</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="proffesion"
                                                        value="{{auth()->user()->proffesion}}" class="form-control"
                                                        id="inputSkills" placeholder="Your proffesion">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="country"
                                                        ...
                                                        id="inputSkills" placeholder="Your country">
                                                </div>
                                            </div>
                                            <div class="form-group row">
